...
void handleRoot() {
  ...
  if (Calculated_dB > 100) {
    noiseMessage = "Very High Noise over 100dB could cause hearing problem if in this condition for long time";
  } else if (Calculated_dB > 80) {
    noiseMessage = "High Noise detected over 80dB";
  } else {
